...
public class Integration_Test {
    ...
    public void t_calculateDebts() {
        ...
        Assert.assertEquals("This user should pay 15 to debt free user",15.0, u2.amountOwedTo(u1),0.001);
        Assert.assertEquals("This user should pay 10 to debt free user",10.0, u3.amountOwedTo(u1),0.001);
    ...
    public void t_calculateDebtsIsSimplified() {
        ...
        Assert.assertEquals("This user should pay 10 to debt free user",5.0, u2.amountOwedTo(u1),0.001);
        Assert.assertEquals("This user should pay 15 to debt free user",15.0, u3.amountOwedTo(u1),0.001);
